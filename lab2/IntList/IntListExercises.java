...
public class IntListExercises {
     ...
     */
    /** change the condition (head.rest != null) to (head != null) **/
     ...
     */
    /** change the condition (x > 10)(error) to (x >= 10) **/
    ...
    public static boolean squarePrimes(IntList lst) {
        ...
        /** original edition(error): return currElemIsPrime || squarePrimes(lst.rest); **/
        boolean atLeastOnePrimes = false;
        IntList p = lst;
        while(p != null){
            ...
            if (currElemIsPrime) {
                p.first *= p.first;
                atLeastOnePrimes = true;
            }
            p = p.rest;
        }
        return atLeastOnePrimes;
    }
}
